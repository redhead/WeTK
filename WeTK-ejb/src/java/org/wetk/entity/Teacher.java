...
@NamedQueries({
	...
	@NamedQuery(name = Teacher.GET_ALL_WITH_CLASS, query = "SELECT t FROM Teacher t WHERE t.clazz.id > 0")
})
public class Teacher extends Person {
	...
	public static final String GET_ALL_WITH_CLASS = "Teacher.getAllWithClass";
